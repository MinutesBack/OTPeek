...
struct Provider {
    ...
    static let all: [Provider] = [
        ...
        Provider(key: "proton", label: "Proton Mail (via Bridge)",
                 ...
                 help: "Needs Proton Mail Bridge running, set to SSL connection mode.",
                 ...
                 steps: [
                    "Install Proton Mail Bridge and sign in to it.",
                    "In Bridge Settings, set the IMAP connection mode to SSL.",
                    "Open your account in Bridge, then Mailbox details.",
